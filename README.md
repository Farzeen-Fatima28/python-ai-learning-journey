...
Documenting my journey learning Python from the ground up, with a focus on building AI-powered applications — part of my preparation for my Final Year Project (Full-Stack + AI integration).

## About Me
Android developer, currently doing an SEO internship, transitioning into full-stack + AI development. Learning Python as a second language alongside JavaScript, aiming to combine mobile, web, and AI skills for my FYP.
